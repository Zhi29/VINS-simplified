...
struct IMG_MSG {
    ...
    vector<double> u_of_point;
    vector<double> v_of_point;
    vector<double> velocity_x_of_point;
    vector<double> velocity_y_of_point;
};
...
public:
    ...
    void PubImageData(double dStampSec, std::string filename);
